...
<H2 align="center">Eve Fielder Collection Keyword Search by</H2>
...
//
	...
	echo "<div align='center' style='padding: 50px 30px 50px;'><form action='fielder_SearchResults.php?searchTerm=" . $searchTerm . "' method='put' name='searchTerm' target='_self'>";
