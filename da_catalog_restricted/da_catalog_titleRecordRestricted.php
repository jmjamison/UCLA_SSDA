...
<body>
<div id="masthead">
         <h1 id="siteName">Social Science Data Archives: Restricted Files</h1> 


         <a href="index.php">Back to Restricted File List</a>
...
if (!$result) { 
	...
	if(count($fileInfo) >= 1) {
		...
		//	echo "To download an entire study choose: <A HREF='addfiles.php?file=&study=" . $studynumber . "&src=" . $studynumber . "'><img src='addall.gif'></a><br><br>";
			...
			echo "<th class='label'  style = 'background-color: powderblue' width=75 >File Type</th>";
			echo "<th class='label'  style = 'background-color: powderblue' width=100 >Note</th>";
