...
<?php
	...
	for ($row_index = 0; $row_index < count($fielder_record); $row_index++ ) {		
		...
		echo "<strong>Title: " . htmlspecialchars($title, ENT_COMPAT) . "</strong><br><br>";
...
echo "<A HREF= '" . $currentHTTP . "fielder_bySubjectList.php?subject=" . $subject . "&subjectID=" . $subjectID  . "'>" . $subject . "</a>   ";
				...
				//$indexterm = $fielder_subject[$row_index]["subject"];
//$indexterm = "<a href='fielder_bySubjectList.php?subject=" . $subject . "'>" . $subject . "</a>";
//print_r($indexterm) . "<br>";		
//$fielder_subjectTemp[$row_index] =  "(" .  $subjectList[$row_index]  .   ") " . $subject;
//print_r($fielder_subject) . "<br>";		
//echo "row_index = " . $row_index . "<br>";	
				}
