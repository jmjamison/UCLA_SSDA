...
<link rel="stylesheet" href="../da_catalog_maintenance/2col_leftNav.css" type="text/css">
<!--  Javascript(s) to 1) paste PI names into text field, 2) clear the text fiels -->
<script language="JavaScript" src="../da_catalog_maintenance/da_catalog.js" type="text/javascript"><!--  da_catalog scripts //--></script>
...
<h1 id="siteName">UCLA Institute for Social Research Data Archives</h1> 
          <h2 id="siteName"><a href="../da_catalog_maintenance/index.php" target="_self">Maintenance Menu</a>&nbsp;/&nbsp;Edit Base Record</h2>  
...
<div style="margin: 1% 5% 2% 2%;line-height: 1.5;	">
  <form <?php 
    ...
    <br><br>
      ...
      <textarea name="cite_text" type="text" cols="200" rows="4"><?php echo $cite_text ?></textarea></label>  
      <br>
 ...
 <form action='../da_catalog_maintenance/da_catalog_processFormCheck.php' method='post' name='editPI'> 
...
<!-- 23-March-2010/jmj commenting out the clear field button, once cleared cant be reloaded with out going back reselecting page -->
 ...
 <form action="../da_catalog_maintenance/da_catalog_insertPICheck.php" method="post" name="addPI" target="_self"> 
...
<form action="../da_catalog_maintenance/da_catalog_processFormCheck.php" method="post" name="editSubject" >
...
<form action="../da_catalog_maintenance/da_catalog_insertSubjectCheck.php" method="post" name="addSubject" target="_self"> 
