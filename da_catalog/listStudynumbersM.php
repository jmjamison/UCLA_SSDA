...
<?php
	...
	//  SELECT * FROM `title` WHERE `StudyNum` like "M%" order by StudyNum
	
	$query = "select title.StudyNum, title.Title FROM title where title.StudyNum Like 'M%'  ORDER BY title.StudyNum";
